    ...
    <footer id="contact" className="bg-gray-900 text-gray-300">
      <div className="container mx-auto px-6 py-12 lg:px-8">
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          {/* Brand */}
          <div>
            <h3 className="mb-4 text-2xl font-bold text-white">AYESHA</h3>
            <p className="mb-4 text-sm">
              Where beauty meets elegance. Experience the art of hair styling with our expert team.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              <li>
                <Link href="#home" className="hover:text-rose-400 transition-colors">
                  Home
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="#stylists" className="hover:text-rose-400 transition-colors">
                  Our Team
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              ...
              <li className="flex gap-2">
                ...
                <span>info@ayeshasalon.com</span>
              </li>
              <li className="flex gap-2">
                <svg className="h-5 w-5 flex-shrink-0 text-rose-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
        ...
        <div className="mt-12 border-t border-gray-800 pt-8 text-center text-sm">
          <p>
            &copy; {currentYear} Ayesha Salon. All rights reserved. Built with{" "}
            <span className="text-rose-400">♥</span> using Next.js
          </p>
        </div>
      </div>
    </footer>
